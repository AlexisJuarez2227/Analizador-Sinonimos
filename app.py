    ...
    for line in lines:
        ...
        for word in words:
            ...
            if re.search(r'\d', word):
                ...
                has_number = True
            elif word_lower in sinonimos:
                sinonimo = sinonimos[word_lower]
                if re.search(r'[\d\W]', sinonimo):
                    output_line.append(word)
                    changed_words.append('palabra combina')
                else:
                    if word.istitle():
                        output_line.append(sinonimo.capitalize())
                    elif word.isupper():
                        output_line.append(sinonimo.upper())
                    else:
                        output_line.append(sinonimo)
